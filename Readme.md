...
> Установка самоподписанного сертификата требуется только для старых версий панели 3x-ui В новых версиях есть возможность выпустить сертивикат Let's Encrypt для ip адреса.
