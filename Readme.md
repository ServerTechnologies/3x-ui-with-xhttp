...
Для установки панели нам понадобится VPS-сервер. Приобрести его можно в [ishosting](https://ishosting.com/affiliate/Mzg3IzY=).  
...
## Установка 3x-ui и создание самоподписанного TLS-сертификата (только для старых версий)

> Установка самоподписанного сертификата требуется только для старых версий панели 3x-ui В новых версиях есть возможность выпустить сертификат Let's Encrypt для ip адреса.
